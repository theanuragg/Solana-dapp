    ...
    var e = {
        ...
        a = function(t, e) {
            if (t) {
                ...
                o && (o.classList.remove(e.navClass), t.content.classList.remove(e.contentClass), l(o, e), n("gumshoeDeactivate", o, {
                    link: t.nav,
                    content: t.content,
                    settings: e
                }))
    ...
    return function(o, r) {
        ...
        v.setup = function() {
            ...
            t ? f && t.content === f.content || (a(f, m), (function(t, e) {
                if (t) {
                    var o = t.nav.closest("li");
                    o && (o.classList.add(e.navClass), t.content.classList.add(e.contentClass), u(o, e), n("gumshoeActivate", o, {
                        link: t.nav,
                        content: t.content,
                        settings: e
                    }))
        ...
        v.destroy = function() {
            f && a(f, m), t.removeEventListener("scroll", p, !1), m.reflow && t.removeEventListener("resize", h, !1), l = null, c = null, f = null, d = null, m = null
        };
        return m = (function() {
            var t = {};
        ...
        })(e, r || {}), v.setup(), v.detect(), t.addEventListener("scroll", p, !1), m.reflow && t.addEventListener("resize", h, !1), v
    }
}));