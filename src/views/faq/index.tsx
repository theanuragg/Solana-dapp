        ...
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-default-200 text-sm font-medium">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Impedit, asperiores quae qui quaerat minus tempora molestias animi, nostrum quas repellat natus optio! Unde amet quae sunt, nulla eveniet laudantium nesciunt?
            </p>
          </div>
        </div>
                ...
                >
                  <div className="px-6 pb-4 pt-0">
                    ...
                    <p className="text-default-300 text-sm font-medium">
                      I always wanted to be an indie hacker.
                    </p>
                  </div>
                </div>
              </div>
